...
| **Holomine (Task 1)** | Medical Mammography Triage | 7-Model Heterogeneous Ensemble (Swin, ConvNeXt, ResNet) + GeM & 8-pass TTA | **0.75000 Kaggle Public LB** | [`breast-cancer-classification`](https://github.com/ababilkhoerulimam/breast-cancer-classification) |
| **Holomine (Task 2)** | Real Estate Price Regression (NLP) | Regex Feature Distillation, TF-IDF Ridge Anchors, Tri-Model Simplex Blending & L1 Calibration | **$333,754 OOF MAE** | [`property-price-prediction-from-sales`](https://github.com/ababilkhoerulimam/property-price-prediction-from-sales) |
...
| **Gayatama Benchmark** | Industrial Waste Classification (10 Classes) | 6-Model Heterogeneous Ensemble (ConvNeXt, Swin, ResNet), Calibrated Soft-Voting & HITL Routing | **97.69% Top-1 Acc** (0.9768 Macro F1) | [`gayatama-waste-clasification`](https://github.com/ababilkhoerulimam/gayatama-waste-clasification) |
